...
class Cate10 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate10({String this.cate, String this.cateId});
  @override
  Cate10State createState() => new Cate10State();
}

class Cate10State extends State<Cate10> {
  @override
  final CateId10Controller productController = Get.put(CateId10Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate10().cateId;

  static Future<List<Product>> fetchCate10() async {
    @override
    var dio = Dio();
    var id = 10;
    // var cateId = id;
