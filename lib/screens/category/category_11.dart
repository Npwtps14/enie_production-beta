...
class Cate11 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate11({String this.cate, String this.cateId});
  @override
  Cate11State createState() => new Cate11State();
}

class Cate11State extends State<Cate11> {
  @override
  final CateId10Controller productController = Get.put(CateId10Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate11().cateId;

  static Future<List<Product>> fetchCate11() async {
    @override
    var dio = Dio();
    var id = 11;
    // var cateId = id;
