...
import 'package:enie_production/controllers/category_controllers/cate_id_14.dart';
...
class Cate14 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate14({String this.cate, String this.cateId});
  @override
  Cate14State createState() => new Cate14State();
}

class Cate14State extends State<Cate14> {
  @override
  final CateId14Controller productController = Get.put(CateId14Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate14().cateId;

  static Future<List<Product>> fetchCate14() async {
    @override
    var dio = Dio();
    var id = 14;
    // var cateId = id;
