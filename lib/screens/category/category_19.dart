...
import 'package:enie_production/controllers/category_controllers/cate_id_19.dart';
...
class Cate19 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate19({String this.cate, String this.cateId});
  @override
  Cate19State createState() => new Cate19State();
}

class Cate19State extends State<Cate19> {
  @override
  final CateId19Controller productController = Get.put(CateId19Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate19().cateId;

  static Future<List<Product>> fetchCate19() async {
    @override
    var dio = Dio();
    var id = 19;
    // var cateId = id;
