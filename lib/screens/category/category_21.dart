...
import 'package:enie_production/controllers/category_controllers/cate_id_21.dart';
...
class Cate21 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate21({String this.cate, String this.cateId});
  @override
  Cate21State createState() => new Cate21State();
}

class Cate21State extends State<Cate21> {
  @override
  final CateId21Controller productController = Get.put(CateId21Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate21().cateId;

  static Future<List<Product>> fetchCate21() async {
    @override
    var dio = Dio();
    var id = 21;
    // var cateId = id;
