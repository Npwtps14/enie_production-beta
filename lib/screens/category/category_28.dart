...
import 'package:enie_production/controllers/category_controllers/cate_id_28.dart';
...
class Cate28 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate28({String this.cate, String this.cateId});
  @override
  Cate28State createState() => new Cate28State();
}

class Cate28State extends State<Cate28> {
  @override
  final CateId28Controller productController = Get.put(CateId28Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate28().cateId;

  static Future<List<Product>> fetchCate28() async {
    @override
    var dio = Dio();
    var id = 28;
    // var cateId = id;
