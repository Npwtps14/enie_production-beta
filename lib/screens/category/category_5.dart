...
import 'package:enie_production/controllers/category_controllers/cate_id_5.dart';
...
class Cate5 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate5({String this.cate, String this.cateId});
  @override
  Cate5State createState() => new Cate5State();
}

class Cate5State extends State<Cate5> {
  @override
  final CateId5Controller productController = Get.put(CateId5Controller());
  ...
  static Future<List<Product>> fetchCate5() async {
    ...
    var response = await dio
        ...
        .get(
            'https://app1.fantasy.co.th/products?product_category_id=$id&pd_status=1');
