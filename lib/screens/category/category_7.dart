...
class Cate7 extends StatefulWidget {
  final cate;
  final cateId;
  const Cate7({String this.cate, String this.cateId});
  @override
  Cate7State createState() => new Cate7State();
}

class Cate7State extends State<Cate7> {
  @override
  final CateId7Controller productController = Get.put(CateId7Controller());

  // final ProductsPage productsPage = ProductsPage().cateId;

  static get cateId => Cate7().cateId;

   

  static Future<List<Product>> fetchCate7() async {
    @override
    var dio = Dio();
    var id = 7;
    // var cateId = id;
